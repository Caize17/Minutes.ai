        ...
        <div>
          ...
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
            ...
            <div className="flex items-center gap-4 self-stretch sm:self-auto justify-between sm:justify-start">
              ...
              {/* User Avatar */}
              <div className="flex items-center gap-3 bg-[#502D55]/5 px-4 py-2.5 rounded-2xl border border-[#502D55]/5">
                <span className="font-plus-jakarta font-extrabold text-[#502D55] text-sm">Camille</span>
                <div className="w-8 h-8 rounded-xl bg-[#502D55] text-white flex items-center justify-center font-plus-jakarta font-black text-sm shadow-md">
                  C
                </div>
              </div>
